...
It is assumed that this dissolution (of unused or recycled materials, daily refuse, lost travelers, and poorly-planned invasions) provides the raw material from which REF[Patterners](patterners) create new islands. Some connection to the ocean would explain why matter conjured by Patterners, when removed from the Unfolding, quickly disintegrates.
